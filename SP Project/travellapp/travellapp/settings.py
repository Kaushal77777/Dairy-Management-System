"""
Django settings for travellapp project.
...
SECRET_KEY = 'i@k6*5kczuz@iyb8rbao_&t)3d3dv#p#83=)tu=#$l*!+k1d$%'
...
WSGI_APPLICATION = 'travellapp.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME' : 'tourism' , # Name of the database*
